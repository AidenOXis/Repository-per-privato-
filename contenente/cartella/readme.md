Si realizzi in linguaggio C/C++ un'applicazione multithread che effettui un calcolo distribuito secondo lo schema seguente, da realizzare utilizzando il costrutto monitor.
